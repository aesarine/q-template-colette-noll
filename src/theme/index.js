export default {
	...
	"fontFamily": {
		...
		"googleLibreCaslonDisplay": "\"Libre Caslon Display\", serif",
		"googleLibreCaslonText": "\"Libre Caslon Text\", serif"
	},
	"font": {
		"headline1": "normal 400 28px/1.3 --fontFamily-googleLibreCaslonDisplay",
		"headline2": "normal 400 48px/1.3 --fontFamily-googleLibreCaslonDisplay",
		"headline3": "normal 400 36px/1.3 --fontFamily-googleLibreCaslonDisplay",
		"base": "normal 300 16px/1.5 --fontFamily-sans",
		"lead": "normal 300 20px/1.5 --fontFamily-sans",
		"headline4": "italic 400 22px/1.3 --fontFamily-googleLibreCaslonDisplay",
		"headline5": "normal 700 16px/1.8 --fontFamily-googleLibreCaslonText",
		"headline6": "normal 400 12px/1.8 --fontFamily-googleLibreCaslonDisplay",
		"paragraph": "normal 400 16px/1.8 --fontFamily-googleLibreCaslonDisplay",
		"menu": "normal 400 16px/1 --fontFamily-googleLibreCaslonDisplay"
	},
	"boxShadow": {
	...
	"background": {
		...
		"bground1": "--color-bgcolor1",
		"bground2": "--color-bgcolor2",
		"bground3": "--color-accent"
	},
	"transform": {
	...
	"transition": {
		...
		"color": "color .15s ease 0s",
		"backgroundColor": "background-color .15s ease 0s",
		"borderColor": "border-color .15s ease 0s",
		"opacity": "opacity .15s ease 0s"
	},
